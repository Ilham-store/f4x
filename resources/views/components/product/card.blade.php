<li class="max-sm:flex">
    <section class="block border border-[#AD8331] rounded-lg p-4 shadow-sm hover:shadow-md transition">
        ...
        <div class="mt-3 space-y-2">
            ...
            <div class="text-lg max-md:text-md font-extrabold max-md:font-bold line-clamp-2">
                {{ $product->name }}
            </div>

            <div class="text-md font-medium sm:font-normal text-amber-600">
                {{ $product->price_short }}
            </div>

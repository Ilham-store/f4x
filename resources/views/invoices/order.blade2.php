...
<body class="bg-gray-100 py-10 print:bg-white print:py-0">
    ...
    <div class="relative max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-10
            print:shadow-none print:rounded-none print:max-w-full overflow-hidden">
        ...
        {{-- <div class="fixed inset-0 flex items-center justify-center pointer-events-none z-0">
            <span
                class="text-9xl font-extrabold opacity-10 rotate-[-30deg] {{ $watermarkClass }} print:opacity-10 print:rotate-[-30deg]">
        ...
        {{-- <div class="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
            <span class="text-[150px] font-extrabold opacity-5 rotate-[-30deg] {{ $watermarkClass }}">
                {{ strtoupper($order->status) }}
            </span>
        </div> --}}
        ...
        <div class="flex items-center gap-4">
            <img src="{{ asset('images/logo.svg') }}" alt="Company Logo" class="h-14">
        ...
        <div class="grid grid-cols-2 gap-6 mt-8">
            ...
            <div class="text-right">
                ...
                @php
                    ...
                    $statusClass = $statusStyles[$order->status] ?? 'border-gray-400 text-gray-700';
                @endphp

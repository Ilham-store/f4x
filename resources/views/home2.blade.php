...
<head>
    ...
    <title>Anvogue - Home Fashion 3</title>
                        ...
                        <ul class="flex items-center gap-8 h-full">
                            <li class="h-full relative">
                                ...
                                <div
                                    ...
                                    <ul>
                                        <li>
                                            <a href="index.html" class="link text-secondary duration-300"> Home Fashion
                                                1 </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="fashion3.html" class="link text-secondary duration-300 active">
                                                Home Fashion 3 </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="pet.html" class="link text-secondary duration-300"> Home Pet Store
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="watch.html" class="link text-secondary duration-300"> Home Watch
                                            </a>
                                        </li>
                                        <li>
                                            <a href="toys.html" class="link text-secondary duration-300"> Home Toys Kid
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="marketplace.html" class="link text-secondary duration-300"> Home
                                                Marketplace </a>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <a href="shop-breadcrumb1.html"
                                                    ...
                                                    <div class="text-content py-14 pl-8 relative z-[1]">
                                                        <div
                                                            ...
                                                            Save $10</div>
                                                        <div class="heading6 mt-2">Dive into Savings <br />on Swimwear
                                                        </div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="product-sale.html"
                                                            class="link text-secondary duration-300"> Products Sale </a>
                                                    </li>
                                                    <li>
                                                        <a href="product-countdown-timer.html"
                                                            class="link text-secondary duration-300"> Products Countdown
                                                            Timer </a>
                                                    </li>
                                                    <li>
                            ...
                            <li class="h-full relative">
                                ...
                                <div class="sub-menu py-3 px-5 -left-10 absolute bg-white rounded-b-xl">
                                    <ul class="w-full">
                                        ...
                                        <li>
                                            <a href="blog-list.html" class="link text-secondary duration-300"> Blog List
                                            </a>
                                        </li>
                                        <li>
                                            <a href="blog-grid.html" class="link text-secondary duration-300"> Blog Grid
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <li class="h-full relative">
                                ...
                                <div class="sub-menu py-3 px-5 -left-10 absolute bg-white rounded-b-xl">
                                    <ul class="w-full">
                                        ...
                                        <li>
                                            <a href="contact.html" class="link text-secondary duration-300"> Contact Us
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="page-not-found.html" class="link text-secondary duration-300"> 404
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="coming-soon.html" class="link text-secondary duration-300"> Coming
                                                Soon </a>
                                        </li>
                                        <li>
            ...
            <div class="marquee-block swiper-container flex items-center whitespace-nowrap">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="text-button-uppercase px-8 text-white">Get 10% off on selected items</div>
                    </div>
                    <div class="swiper-slide">
                        <div class="line w-8 h-px bg-white"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="text-button-uppercase px-8 text-white">10% off swim suits</div>
                    </div>
                    <div class="swiper-slide">
                        <div class="line w-8 h-px bg-white"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="text-button-uppercase px-8 text-white">Free shipping on all orders over $50</div>
                    </div>
                    <div class="swiper-slide">
                        <div class="line w-8 h-px bg-white"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="text-button-uppercase px-8 text-white">10% off on all summer essentials!</div>
                    </div>
                    <div class="swiper-slide">
                        <div class="line w-8 h-px bg-white"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="text-button-uppercase px-8 text-white">Get summer-ready: 10% off swim suits</div>
                    </div>
                    <div class="swiper-slide">
                        <div class="line w-8 h-px bg-white"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="text-button-uppercase px-8 text-white">10% off on all product</div>
                    </div>
                    <div class="swiper-slide">
                        <div class="line w-8 h-px bg-white"></div>
                    </div>
